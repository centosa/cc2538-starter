...
macro_rules! uart_assert_taken {
    ...
    ($uart:literal) => {
        ...
        reg::assert_taken!(concat!($uart, "_lcr"));
        reg::assert_taken!(concat!($uart, "_fr"));
        reg::assert_taken!(concat!($uart, "_dr"));
        reg::assert_taken!(concat!($uart, "_im"));
        reg::assert_taken!(concat!($uart, "_cc"));
    }
}
